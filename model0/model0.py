...
if __name__ == '__main__':
    ...
    V_WALK = ASC_WALK + B_TIME * DUR_WALKING
    V_BIKE = ASC_BIKE + B_TIME * DUR_CYCLING
    V_PT = ASC_PT + B_TIME * DUR_PT + B_COST * COST_TRANSIT
    V_CAR = ASC_CAR + B_TIME * DUR_DRIVING + B_COST * COST_DRIVING
